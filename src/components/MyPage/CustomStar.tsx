...
export default function CustomStar(props: CustomStarProps) {
  ...
  return (
    <svg width="19" height="19" viewBox="0 0 19 19" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <linearGradient id={`progress-${id}`} x1="0" y1="0" x2="1" y2="0">
          <stop offset={`${guage}`} stopColor={theme.colors.ohou_skyblue} />
          <stop offset={`${guage}`} stopColor={theme.colors.ohou_gray03} />
        </linearGradient>
      </defs>
    </svg>
  );
